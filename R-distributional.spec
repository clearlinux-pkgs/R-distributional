...
Version  : 0.3.2
Release  : 13
URL      : https://cran.r-project.org/src/contrib/distributional_0.3.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/distributional_0.3.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679503476
